...
# Where are we
setwd('/Users/esbl/Dropbox (University of Oregon)/Projects/ThermoFisher/DOE6')

currentDate <- Sys.Date()
meta = read_xlsx("DOE6-metadata.xlsx")
write.csv(meta, paste("/Users/esbl/Dropbox (University of Oregon)/Projects/ThermoFisher/DOE6/Metadata_record/Metadata-",currentDate,".csv",sep=""))

# What are our files? 
files = list.files('/Users/esbl/Dropbox (University of Oregon)/Projects/ThermoFisher/DOE6/data')

Cqs = data_frame()


for (f in files) {
  setwd('/Users/esbl/Dropbox (University of Oregon)/Projects/ThermoFisher/DOE6/data')
...
output1 <- cbind(meta, output1[match(meta$`SampleID`, output1$Sample), ])
output1$Sample <- NULL
write.csv(output1, "/Users/esbl/Dropbox (University of Oregon)/Projects/ThermoFisher/DOE6/Results/DOE6_Results.csv")
