...
meta = read_xlsx("C:\\Users\\ano\\Dropbox (University of Oregon)\\Projects\\ThermoFisher\\DOE7\\DOE7_Nebulization_Metadata.xlsx")

# What are our files? 
files = list.files("C:\\Users\\ano\\Dropbox (University of Oregon)\\Projects\\ThermoFisher\\DOE7\\Data\\Raw_Results")

Cqs = data_frame()

for (f in files) {
  setwd("C:\\Users\\ano\\Dropbox (University of Oregon)\\Projects\\ThermoFisher\\DOE7\\Data\\Raw_Results")
...
write.csv(output3, "C:\\Users\\ano\\Dropbox (University of Oregon)\\Projects\\ThermoFisher\\DOE7\\DOE7 Results.csv")
