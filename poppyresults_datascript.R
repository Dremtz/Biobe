...
# Where are we
setwd('C:\\Users\\ano\\Dropbox (University of Oregon)\\Projects\\Poppy Air Sampler\\Data')


meta = read_xlsx("C:\\Users\\ano\\Dropbox (University of Oregon)\\Projects\\Poppy Air Sampler\\Data\\poppy metadata.xlsx")

# What are our files? 
files = list.files("C:\\Users\\ano\\Dropbox (University of Oregon)\\Projects\\Poppy Air Sampler\\Data\\raw_results")

Cqs = data_frame()

for (f in files) {
  setwd("C:\\Users\\ano\\Dropbox (University of Oregon)\\Projects\\Poppy Air Sampler\\Data\\raw_results")
  qp1 <- read.csv(f, header = T,skip = 24) 
...
write.csv(output3, 'C:\\Users\\ano\\Dropbox (University of Oregon)\\Projects\\Poppy Air Sampler\\Data\\poppyresults.csv')
