...
qp1 <- read.csv('/Users/esbl/Dropbox (University of Oregon)/Projects/Active_Air_Cleaning _Projects/DAT_Project Data/R_Data/Genesis_DATA/GE_SEPI_DATA/GE_RAW_SEPI_PMA1A.csv', header = T,skip = 23, stringsAsFactors = F)
...
#2 REPEAT FOR 2ND PLATE: PMA 2nd PMA Plate
qp2 <- read.csv('/Users/esbl/Dropbox (University of Oregon)/Projects/Active_Air_Cleaning _Projects/DAT_Project Data/R_Data/Genesis_DATA/GE_SEPI_DATA/GE_RAW_SEPI_PMA3.csv', header = T,skip = 23, stringsAsFactors = F)
...
meta = read.csv("/Users/esbl/Dropbox (University of Oregon)/Projects/Active_Air_Cleaning _Projects/DAT_Project Data/ONSite_GenesisAir_Metadata_R.csv")
...
SEPI_PMA_COMBINED <- cbind(meta, qp1.3[match(meta$Sample.Number, qp1.3$Sample), ])
...
qp4 <- read.csv('/Users/esbl/Dropbox (University of Oregon)/Projects/Active_Air_Cleaning _Projects/DAT_Project Data/R_Data/Genesis_DATA/GE_SEPI_DATA/GENESIS_RAW_SEPI_PBS1.csv', header = T,skip = 23, stringsAsFactors = F)
...
qp5 <- read.csv('/Users/esbl/Dropbox (University of Oregon)/Projects/Active_Air_Cleaning _Projects/DAT_Project Data/R_Data/Genesis_DATA/GE_SEPI_DATA/GENESIS_RAW_SEPI_PBS2.csv', header = T,skip = 23, stringsAsFactors = F)
...
standards5 <- standards5[!grepl('Standard 4', standards5$Sample),]
...
write.csv(SEPI_bound, ' SEPI_COMPLETE')

SEPI_COMPLETE_CLEANED <- SEPI_bound[grepl('1|2|3|4|5|6B|7|8', SEPI_bound$Sample.Day), ]
write.csv(SEPI_COMPLETE_CLEANED , 'GE_SEPI_COMPLETE_CLEANED.csv')
